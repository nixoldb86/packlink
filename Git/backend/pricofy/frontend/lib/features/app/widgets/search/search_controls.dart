...
class _AnimatedControlsBarState extends State<AnimatedControlsBar>
  ...
  Widget build(BuildContext context) {
      ...
      return FadeTransition(
        ...
        child: Row(
          children: [
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Padding(
                      ...
                      child: Icon(Icons.search, size: 18, color: AppTheme.gray400),
                    ),
                    ...
                    suffixIcon: _searchController.text.isNotEmpty
                        ? GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: Icon(Icons.clear, size: 16, color: AppTheme.gray400),
                            ),
                          )
                        : null,
            ...
            // iOS-style filter button
            _buildIOSFilterButton(context, searchProvider),
            const SizedBox(width: 8),

            // iOS-style segmented control for view mode
            _buildIOSViewModeToggle(searchProvider),
            const SizedBox(width: 10),

            // Close button (modern style with gradient, circular, smaller)
            GestureDetector(
    ...
    // Collapsed state: just the toggle button (gear icon with gradient)
    return GestureDetector(
      onTap: widget.onToggle,
      child: Container(
        width: 36,
  ...
  /// iOS-style filter button with badge (single icon: tune/equalizer)
